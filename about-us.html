...
<head>
    ...
    <title>About us | ISIC </title>

    <link rel='stylesheet' href='css/boostrap-libs.min.css' type='text/css' media='all' />
    ...
    <script type='text/javascript' src='js/element-query.min.js'></script>
    <script type='text/javascript' src='js/theme-libs.js'></script>

    <script type='text/javascript' src='js/theme.js'></script>
    <!--[if lt IE 9]>
		<script type='text/javascript' src='js/html5shiv.min.js?ver=3.3.0'></script>
	<![endif]-->
    <!--[if lt IE 9]>
		<script type='text/javascript' src='js/respond.min.js?ver=3.3.0'></script>
	<![endif]-->
...
<body class="main-menu-sticky-smart ">
                                ...
                                <div id="menu-top" class="menu top-menu-wrapper" role="navigation">
                                    <nav class="top-menu-container">
                                        ...
                                        <ul id="top-navigation" class="top-menu menu">
                                            <li>
                                                <a href="mailto:jude@unitedventuressl.com" class="topbar-sign-in">
                                                    <img src="images/icons/email.png"> jude@unitedventuressl.com
                                                </a>
                                            </li>
                                            <li>
                                                <span class="topbar-sign-in ">
													<img src="images/icons/phone.png"> 
													 <a href="tel:+94115474747" class="topbar-sign-in">+94 115 47 47 47 </a>|  <a href="tel:+94115220085" class="topbar-sign-in">+94 115 22 00 85  </a>
												</span>
                                            </li>
                                            <li>
                                                <span class="topbar-sign-in ">
													<img src="images/icons/location.png"> 
													 ISIC/STA Travel | 3rd Floor | No. 54 Walukarama Road | Colombo 3 | Sri Lanka
												</span>
                                            </li>
                                    ...
                                    <nav class="top-menu-container ">
                                        <ul id="top-navigation" class="top-menu menu pull-right">
                                            <li>
                                                <a href="#" class="topbar-sign-in social-icons icon-circle">
	...
	<a href="#" rel="home">
					<img id="logo" src="images/isic2_logo.png"
			     alt="isic logo"  />
            ...
            <div class="bg-black padd-v-25">
                <div class="bg-green dis-flex pos-rela over-hidden">
                    <div class="col-md-9 col-xs-12 text-upper padd-h-25">
                        ...
                        <div class="off-canvas-container right skin-white">
                            <div class="off-canvas-inner dis-tbl full-width">
								...
								<img src="images/airplane.png" class="flipH marg-n-left-25">
								<br>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-sm-4 no-padd">
                                                <div class="col-sm-12 no-padd">
                                                    <div class="col-sm-4 padd-h-5">
                                                        <div class="input-group">
                                                            <input id="appendedcheckbox" name="appendedcheckbox" class="form-control text-upper" type="text" placeholder="mobile">

                                                        </div>
                                                    </div>
                                                    <div class="col-sm-8 padd-h-5">
                                                        <div class="input-group">
                                                            <input id="appendedcheckbox" name="appendedcheckbox" class="form-control text-upper" type="text" placeholder="e-mail">
                                                ...
                                                <input type="submit" value="get a quote" class="btn btn-primary pull-right">
                    ...
                    <div class="col-md-3 col-xs-12 pos-rela take-top1k" style="background:url('images/header-back.jpg') right bottom / cover">
                        <h3 class="txt-green-light text-upper"><span class="txt-yellow">click here to <br>enjoy your journey</h3>
                        <img src="images/airplane.png" class="off-canvas-menu-icon marg-n-left-25">
                    </div>
                        ...
                        <div class="">
                            ...
                            <nav class="main-menu-container">
                                <ul id="main-navigation" class="main-menu menu bsm-pure clearfix">
                                    <li class="menu-item menu-item-object-page current-menu-item page_item current_page_item better-anim-fade "><a href="#">Home</a></li>
                                    <li class="menu-item menu-item-object-page "><a href="#">About</a></li>
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category better-anim-slide-bottom-in menu-item-has-children menu-item-has-mega menu-item-mega-tabbed-grid-posts "><a href="#">Cards</a>

                                        <div class="mega-menu tabbed-grid-posts">
                                            <div class="content-wrap clearfix">
                                                <ul class="tabs-section">
                                                    <li class="active">
                                                        <a href="#" data-toggle="tab" aria-expanded="true" class="">
                                                            <i class="fa fa-angle-right"></i> All </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <i class="fa fa-angle-right"></i> Vogue </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                    ...
                                                    <div class="tab-pane bs-tab-anim bs-tab-animated active">
                                                        <div class="bs-pagination-wrapper main-term-2 next_prev ">
                                                            <div class="listing listing-grid listing-grid-1 clearfix columns-3">
                                                                <div class="post-71 type-post format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-3">

                                                                    <div class="featured clearfix">
                                                                        <div class="term-badges floated"><span class="term-badge term-3"><a href="#">Beauty</a></span></div>
                                                                        <a title="..." data-src="http://localhost/ISIC/images/menu_1.jpg" class="img-holder" href="#"></a>

                                                                    </div>
                                                                    <p class="title"> <a href="#" class="post-title post-url">
																	A detailed guide to celebrity athleisure lines	</a>
                                                                    </p>
                                                                </div>
                                                                <div class="format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-2">

                                                                    <div class="featured clearfix">
                                                                        <div class="term-badges floated"><span class="term-badge term-2"><a href="#">Fashion</a></span></div>
                                                                        <a title="..." data-src="http://localhost/ISIC/images/menu_2.jpg" class="img-holder" href="#"></a>

                                                                    </div>
                                                                    <p class="title"> <a href="#" class="post-title post-url">
																		Why self esteem sucks, And why you don&#x2019;t need It	</a>
                                                                    </p>
                                                                </div>
                                                                <div class="type-post format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-2">

                                                                    <div class="featured clearfix">
                                                                        <div class="term-badges floated"><span class="term-badge term-2"><a href="#">Fashion</a></span></div>
                                                                        <a title="..." data-src="http://localhost/ISIC/images/menu_3.jpg" class="img-holder" href="#"></a>

                                                                    </div>
                                                                    <p class="title"> <a href="#" class="post-title post-url">
		PRINCE see how the fashion world was influenced by Prince&#x2019;s Legendary style	</a>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tab-pane bs-tab-anim bs-deferred-container" id="mtab-138714531-5">

                                                    </div>
                                                    <div class="tab-pane bs-tab-anim bs-deferred-container" id="mtab-138714531-3">

                                                    </div>
                                                    <div class="tab-pane bs-tab-anim bs-deferred-container" id="mtab-138714531-4">
                                    ...
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category better-anim-slide-fade menu-item-has-children menu-item-has-mega menu-item-mega-grid-posts"><a href="#">Discounts</a>

                                        <div class="mega-menu mega-grid-posts">
                                            <div class="content-wrap bs-tab-anim bs-tab-animated active">
                                                <div class="bs-pagination-wrapper main-term-6 next_prev ">
                                                    <div class="listing listing-grid listing-grid-1 clearfix columns-4">
                                                        <div class="post-60 type-post format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-7">

                                                            <div class="featured clearfix">
                                                                <div class="term-badges floated"><span class="term-badge term-7"><a href="#">Family Activity</a></span></div>
                                                                <a title="..." data-src="http://localhost/ISIC/images/menu_4.jpg" class="img-holder" href="#"></a>
		...
		10 Simple habits that will make lead you to true happiness	</a>
                                                        ...
                                                        <div class="type-post format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-7">

                                                            <div class="featured clearfix">
                                                                <div class="term-badges floated"><span class="term-badge term-7"><a href="#">Family Activity</a></span></div>
                                                                <a title="How to use apple cider vinegar for effective weight loss" data-src="http://localhost/ISIC/images/menu_5.jpg" class="img-holder" href="#"></a>

                                                            </div>
                                                            <p class="title"> <a href="#" class="post-title post-url">
		How to use apple cider vinegar for effective weight loss	</a>
                                                            </p>
                                                        </div>
                                                        <div class="type-post format-audio has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-8">

                                                            <div class="featured clearfix">
                                                                <div class="term-badges floated"><span class="term-badge term-8"><a href="#">Health</a></span></div>
                                                                <a title="..." data-src="http://localhost/ISIC/images/menu_6.jpg" class="img-holder" href="#"></a>
		...
		The difference between looking good and feeling good	</a>
                                                        ...
                                                        <div class="type-post format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-7">
                                                            ...
                                                            <div class="featured clearfix">
                                                                <div class="term-badges floated"><span class="term-badge term-7"><a href="#">Family Activity</a></span></div>
                                                                <a title="..." data-src="http://localhost/ISIC/images/menu_7.jpg" class="img-holder" href="#"></a>
		...
		What to wear this spring no matter What you&#x2019;re up to	</a>
                                    ...
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category better-anim-slide-bottom-in menu-item-has-children menu-item-has-mega menu-item-mega-tabbed-grid-posts "><a href="#">Travel With us</a>
                                        <!-- Mega Menu Start -->
                                        <div class="mega-menu tabbed-grid-posts">
                                            <div class="content-wrap clearfix">
                                                <ul class="tabs-section">
                                                    <li class="active">
                                                        <a href="#" data-target="#mtab-138714531-2" data-toggle="tab" aria-expanded="true" class="term-2">
                                                            <i class="fa fa-angle-right"></i> All </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-target="#mtab-138714531-5" data-deferred-init="1680094127" data-toggle="tab" data-deferred-event="mouseenter" class="term-5">
                                                            <i class="fa fa-angle-right"></i> Vogue </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-target="#mtab-138714531-3" data-deferred-init="1592610434" data-toggle="tab" data-deferred-event="mouseenter" class="term-3">
                                                            <i class="fa fa-angle-right"></i> Beauty </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-target="#mtab-138714531-4" data-deferred-init="317330002" data-toggle="tab" data-deferred-event="mouseenter" class="term-4">
                                                            <i class="fa fa-angle-right"></i> Street fashion </a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane bs-tab-anim bs-tab-animated active" id="mtab-138714531-2">
                                                        <div class="bs-pagination-wrapper main-term-2 next_prev ">
                                                            <div class="listing listing-grid listing-grid-1 clearfix columns-3">
                                                                <div class="type-post format-standard has-post-thumbnail  simple-grid  listing-item listing-item-grid listing-item-grid-1 main-term-3">

                                                                    <div class="featured clearfix">
                                                                        <div class="term-badges floated"><span class="term-badge term-3"><a href="#">Beauty</a></span></div>
                                                                        <a title="..." data-src="http://localhost/ISIC/images/menu_8.jpg" class="img-holder" href="#"></a>
		...
		PRINCE see how the fashion world was influenced by Prince&#x2019;s Legendary style	</a>
                                    ...
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category  better-anim-fade "><a href="#"> contact </a></li>
                                </ul>
        ...
        <div class="content-wrap">
			...
			WHAT IS ISIC?
                        ...
                        <img src="" alt="...." data-src="http://localhost/ISIC/images/id-card.jpg" class="img-responsive img-cont pull-left marg-rgt-15"></a>
                        <p class="txt-white">
                    ...
                    <div class="row dis-flex">
                        <div class="col-md-9 col-sm-12 col-xs-12 padd-h-5 padd-v-40">
                            ...
                            <div class="col-sm-4 col-xs-12 bg-white padd-v-15 ">
                                ...
                                <img src="" alt="...." data-src="http://localhost/ISIC/images/google-play-icon.png" class="img-responsive img-cont pull-left">
                                <img src="" alt="...." data-src="http://localhost/ISIC/images/apple-app-store.png" class="img-responsive img-cont pull-left">
                                ...
                                <div class="dis-tbl-row full-height full-width tbl-con-algn-center">
                                    <div class="dis-tbl full-height full-width">
                                        <div class="dis-tbl-cell full-height full-width tbl-con-algn-center">
                                            <img id="logo" src="images/isic2_logo.png" alt="isic logo" class="img-responsive padd-v-15 center-block" />
