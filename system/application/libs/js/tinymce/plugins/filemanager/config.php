...
$base_url=HTTP_PATH; //url base of site if you want only relative url leave empty
$upload_dir = 'uploads/'; // path from base_url to upload base dir
$current_path = $ADMIN_SETTINGS['FILEMANAGER_CURRENT_PATH']; // relative path from filemanager folder to upload files folder
