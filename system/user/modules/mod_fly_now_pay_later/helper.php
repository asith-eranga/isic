...
class Mod_FlyNowPayLater extends Default_DBConnection implements Default_DBInterface {
      private $id;
	  private $name;
      private $image;
      private $description;
      ...
      private $table_name = "fly_now_pay_later";
      ...
      function createTable() {
            $sql = 'CREATE TABLE IF NOT EXISTS `fly_now_pay_later` (
      ...
      function getAllStatus() {
            ...
            $data = $variable_manager->getVariableValue("mod_fly_now_pay_later_status", array("value" => "Disable,Enable", "mod_name" => "mod_fly_now_pay_later"));
            return explode(",", $data);
      }
