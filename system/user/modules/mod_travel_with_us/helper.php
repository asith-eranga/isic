...
class Mod_TravelWithUs extends Default_DBConnection implements Default_DBInterface {
      ...
      private $table_name = "travel_with_us";
      ...
      function createTable() {
            ...
            $sql = 'CREATE TABLE IF NOT EXISTS `travel_with_us` (
      ...
      function getAllStatus() {
            ...
            $data = $variable_manager->getVariableValue("mod_travel_with_us_status", array("value" => "Disable,Enable", "mod_name" => "mod_travel_with_us"));
