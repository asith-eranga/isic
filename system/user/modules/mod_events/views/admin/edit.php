...
$bt_data = $events->getById();
$events->extractor($bt_data);

$data		= $events->selectAll();
	...
	$('.ui.form').form({
		...
		description: {
			...
			rules: [
				{
					type: 'empty',
					prompt: 'Please enter event content'
				}
			]
		},
...
<div class="thirteen wide column">
		...
		<h2 class="ui header">
		  ...
		  <div class="content">
		    Edit Event
		    <div class="sub header">Edit event details</div>
		  </div>
		</h2>
	...
	<form id="data_form">
      ...
      <input type="hidden" id="id" name="id" value="<?php echo $events->id(); ?>" />
      
      <div class="field">
        <label>Name</label>
        <input placeholder="Name" id="name" name="name" type="text" value="<?php echo $events->name(); ?>">
      </div>
      
      <div class="field">
        <label>Description</label>
        <textarea cols="80" rows="5" placeholder="Add Description" id="description" name="description"><?php echo $events->description(); ?></textarea>
      </div>
      
      <div class="fields" id="image_preview_wrapper">
	  	<input type="hidden" id="image" name="image" value="<?php echo $events->image(); ?>"/>
	  ...
	  <div class="field">
        ...
        <div class="ui selection dropdown">
          <input type="hidden" id="status" name="status" value="<?php echo $events->status(); ?>">
          <div class="default text"><?php echo $status[$events->status()]; ?></div>
