...
class Mod_Events extends Default_DBConnection implements Default_DBInterface {
      ...
      function getAllStatus() {
            ...
            $data = $variable_manager->getVariableValue("mod_events_status", array("value" => "Disable,Enable", "mod_name" => "mod_events"));
