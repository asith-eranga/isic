...
$bt_data   = $special_tours->getById();
$special_tours->extractor($bt_data);

$data		= $special_tours->selectAll();
...
<div class="thirteen wide column">
		...
		<h2 class="ui header">
		  ...
		  <div class="content">
		    Edit Special Tour
		    <div class="sub header">Edit special tour</div>
		  </div>
		</h2>
	...
	<form id="data_form">
      ...
      <input type="hidden" id="id" name="id" value="<?php echo $special_tours->id(); ?>" />
      
      <div class="field">
        <label>Title</label>
        <input placeholder="Name" id="name" name="name" type="text" value="<?php echo $special_tours->name(); ?>">
      </div>
      
      <div class="field">
        <label>Description</label>
        <textarea cols="80" rows="5" placeholder="Add Description" id="description" name="description"><?php echo $special_tours->description(); ?></textarea>
      </div>
      
      <div class="fields" id="image_preview_wrapper">
	  	<input type="hidden" id="image" name="image" value="<?php echo $special_tours->image(); ?>"/>
	  ...
	  <div class="field">
        ...
        <div class="ui selection dropdown">
          <input type="hidden" id="status" name="status" value="<?php echo $special_tours->status(); ?>">
          <div class="default text"><?php echo $status[$special_tours->status()]; ?></div>
