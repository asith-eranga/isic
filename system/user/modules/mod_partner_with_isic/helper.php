...
class Mod_PartnerWithIsic extends Default_DBConnection implements Default_DBInterface {
      ...
      private $table_name = "partner_with_isic";
      ...
      function createTable() {
            ...
            $sql = 'CREATE TABLE IF NOT EXISTS `partner_with_isic` (
      ...
      function getAllStatus() {
            ...
            $data = $variable_manager->getVariableValue("mod_partner_with_isic_status", array("value" => "Disable,Enable", "mod_name" => "mod_partner_with_isic"));
