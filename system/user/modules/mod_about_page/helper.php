...
class Mod_AboutPage extends Default_DBConnection implements Default_DBInterface {
    ...
    private $table_name = "content_about";
    ...
    function createTable() {
        $sql = 'CREATE TABLE IF NOT EXISTS `content_about` (
        ...
        // Run on first time
        /*$about_content = "INSERT INTO content_about(title, description, sort_order) VALUES
                          ('what is isic?', 'description of what is isic', 0),
                          ('why isic?', 'description of why isic', 1),
                          ('for who?', 'description of for who', 2)";
        $this->MDatabase->customNoResults($about_content);*/
    }
