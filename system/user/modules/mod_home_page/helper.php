...
class Mod_HomePage extends Default_DBConnection implements Default_DBInterface {
    ...
    private $table_name = "content_home";
    ...
    function createTable() {
        $sql = 'CREATE TABLE IF NOT EXISTS `content_home` (
        ...
        // Run on first time
        /*$home_content = "INSERT INTO content_home(title, description, sort_order) VALUES
                          ('what is isic?', 'description of what is isic ', 0),
                          ('why isic?', 'description of why isic ', 1)";
        $this->MDatabase->customNoResults($home_content);*/
    }
