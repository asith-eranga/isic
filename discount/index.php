                        ...
                        <div class="">
                            ...
                            <nav class="main-menu-container">
                                <ul id="main-navigation" class="main-menu menu bsm-pure clearfix">
                                    <li class="menu-item menu-item-object-page better-anim-fade "><a href="#">Home</a></li>
                                    <li class="menu-item menu-item-object-page "><a href="#">About</a></li>
                                    <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children "><a href="#">Cards</a>
    <ul class="sub-menu">
        ...
        <li class="menu-item  better-anim-fade "><a href="#">Teachers</a></li>
                                          ...
                                          <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children current-menu-item current_page_item "><a href="#">Discounts</a>
    <ul class="sub-menu">
        ...
        <li class="menu-item  better-anim-fade "><a href="#">Insurance</a></li>
                                    ...
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category  better-anim-fade "><a href="#"> Partner with isic </a></li>
                                      <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children "><a href="#">Travel With us</a>
    <ul class="sub-menu">
                                    ...
                                    <div class="mg-col mg-col-2">
                                        <div class="mg-row mg-row-1">
                                            <div class="item-3-cont">
                                                <article class="type-post format-standard has-post-thumbnail  listing-item-3 listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item main-term-2">
                                                    <div class="item-content">
                                                        <a title="See how the fashion world was influenced by Prince’s Legendary" data-src="http://localhost/ISIC/images/img-1.jpg" class="img-cont" href="#"></a>
                                            ...
                                            <div class="item-4-cont">
                                                <article class="type-post format-standard has-post-thumbnail  listing-item-4 listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item main-term-3">
                                                    <div class="item-content">
                                                        <a title="..." data-src="http://localhost/ISIC/images/img-2.jpg" class="img-cont" href="#"></a>
                                        ...
                                        <div class="mg-row mg-row-2">
                                            <article class="type-post format-standard has-post-thumbnail  listing-item-2 listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item main-term-2">
                                                <div class="item-content">
                                                    <a title="..." data-src="http://localhost/ISIC/images/img-4.jpg" class="img-cont" href="#"></a>
                                                    <span class="format-icon format-audio"><i class="fa fa-eye"></i></span>

                                                    <div class="content-container">
                                                        <img src="http://localhost/ISIC/images/power-world-logo.jpg" class="img-responsive pull-left">
...
members control over their health is paramount ....</span>
                                    ...
                                    <div class="mg-col mg-col-1">
                                        <article class="type-post format-standard has-post-thumbnail  listing-item-1 listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item main-term-4">
                                            <div class="item-content">
                                                <a title="..." data-src="http://localhost/ISIC/images/img-3.jpg" class="img-cont " href="#"></a>
                                    ...
                                    <div class="">
                                        <div class="item-3-cont">
                                            <article class="type-post format-standard has-post-thumbnail  listing-item-5 listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item main-term-2">
                                                <div class="item-content">
                                                    <a title="See how the fashion world was influenced by Prince’s Legendary" data-src="http://localhost/ISIC/images/img-5.jpg" class="img-cont " href="#"></a>
                                        ...
                                        <div class="item-4-cont">
                                            <article class="type-post format-standard has-post-thumbnail listing-item-6 listing-item listing-mg-item listing-mg-type-1 listing-mg-1-item main-term-3">
                                                <div class="item-content">
                                                    <a title="..." data-src="http://localhost/ISIC/images/img-6.jpg" class="img-cont" href="#"></a>
				...
				<div class="dis-tbl full-height full-width">
					...
					<div class="border-bottom">
                        <div class=" padd-v-5 pos-rela"><a class="txt-white " href="#">ISIC <img src="images/icons/cat-1.png"></a></div>
                        <div class=" padd-v-5 pos-rela"><a class="txt-white " href="#">ITIC <img src="images/icons/cat-2.png"></a></div>
                        <div class=" padd-v-5 pos-rela"><a class="txt-white " href="#">IYTC <img src="images/icons/cat-3.png"></a></div>
